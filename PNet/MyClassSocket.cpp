...
namespace PNet {
    ...
    Result Socket::Create()
    {
        ...
        if (SetSocketOption(SocketOption::TCP_NoDelay, TRUE) != Result::P_sucksess)
        {
            return Result::P_GenericError;
        }
    ...
    Result Socket::Accpet(Socket& outSock)
    {
        ...
        SocketHandle acceptedConnectionHabndle = accept(handle,(sockaddr*)(&addrin),&storeSize);
    ...
    // the important func in my project e
